...
function MusicDetail({ nav, data, player, account }) {
  ...
  if (data?.videoUrl || data?.musicVideoUrl) return <MusicVideoDetail nav={nav} video={data} player={player} account={account} />;
