...
function GovernanceDashboard({ nav, account }) {
  ...
  const applyRoleAction = (targetUserId, roleCode, action, reason) => act(() => superAdminSetRole(targetUserId, roleCode, action, reason), `Role action ${action.toLowerCase()} completed and audit logged.`);
