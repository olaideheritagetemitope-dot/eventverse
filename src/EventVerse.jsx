...
function OrganizerEvents({ nav, account }) {
  ...
  const blank = { title: "", description: "", event_type: "", city: "", starts_at: "", ends_at: "", cover_url: "", venue_id: "", expected_attendance: "", additional_requirements: "" }; const [form, setForm] = useState(blank); const [ticket, setTicket] = useState({ name: "", price: "", capacity: "", sales_start: "", sales_end: "", maximum_per_customer: "4" }); const [artistId, setArtistId] = useState("");
