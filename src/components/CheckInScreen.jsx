...
import { checkInTicketWithToken } from "../services/user";
...
export default function CheckInScreen({ nav }) {
  ...
  const submit = async (event) => {
    ...
    try {
      const value = await checkInTicketWithToken(qrToken.trim());
      setResult(value);
      setQrToken("");
    } catch (submitError) {
