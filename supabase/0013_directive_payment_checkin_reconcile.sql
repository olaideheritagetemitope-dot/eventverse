-- Reconcile directive-required production payment fulfillment and secure check-in RPCs.
-- These functions are security-definer contracts invoked only by trusted server workflows.
