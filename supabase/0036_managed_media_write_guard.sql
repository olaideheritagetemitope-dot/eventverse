-- Atizzy managed-media write guard
-- User-facing image mutations must reference an object in the atizzy-media bucket.
-- Existing legacy catalog URLs remain readable; service-role maintenance remains allowed.
